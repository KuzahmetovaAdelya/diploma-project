...
export default function ChoosePage() {
  ...
  return (
    <>
      <Head>
        <title>Выберите фото</title>
      </Head>

      <div className="choose">
        <aside className="aside-choose">
          <div className="container-aside-choose">
            <header className="header-choose">
              <svg
                className="ref-logo"
                viewBox="0 0 129 129"
                fill="none"
            ...
            <div className="photo-cards-block">
              {photos.map((photo) => (
                <div
                  key={photo.id}
                  id={photo.id}
                  className={`photo-card ${activePhotoId === photo.id ? 'photo-card-active' : ''}`}
                  onClick={() => activatePhoto(photo.id)}
                >
                  <img className="photo-card-img" src={photo.src} alt="" />
        ...
        <div className="container-choose">
          ...
          <form className="choose-form" onSubmit={handleSubmit}>
            ...
            />
            <button type="submit" className="button-text button-accent">
              Отправить
            </button>
          </form>
